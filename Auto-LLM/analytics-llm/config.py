...
class AnalyticsLLMConfig:
    ...
    if not CEREBRAS_API_KEY:
        raise ValueError("CEREBRAS_API_KEY not found in environment variables. Please set it in your .env file.")

    MODEL_NAME = os.getenv("ANALYTICS_MODEL", "llama3.1-8b")
    TEMPERATURE = float(os.getenv("ANALYTICS_TEMPERATURE", "0.3"))
    MAX_TOKENS = int(os.getenv("ANALYTICS_MAX_TOKENS", "2000"))
